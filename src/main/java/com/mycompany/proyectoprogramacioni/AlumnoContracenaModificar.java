...
public class AlumnoContracenaModificar extends javax.swing.JFrame {
private Alumno modificarAlumno;
    public AlumnoContracenaModificar() {
        initComponents();
        modificarAlumno = ProyectoProgramacionI.alumnoLogeado;
         jTextField1.setText(modificarAlumno.getContracena());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (password.matches("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]+$")) {
            modificarAlumno.setContracena(password);
