...
public class ProfesorContracenaModificar extends javax.swing.JFrame {

    private Profesor modificarProfesor;

    public ProfesorContracenaModificar() {
        initComponents();
        this.setLocationRelativeTo(null);
        modificarProfesor = ProyectoProgramacionI.profesorLogeado;
